...
class mainConfig // contains the main config
{
	var $value;
	function __construct()
	{
		$value = require("../config/config.php");
	}
	
	public function compile() // compile the config files
	{
	...
	protected function saveConfig($configArray) // save a config array to config/config.php
	{
	...
	protected function readConfigFile($relativePath) // read and decode the contents of a config file
	{
